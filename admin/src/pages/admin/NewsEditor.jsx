        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border-color)', borderRadius: '8px', overflow: 'hidden' }}>
            <div style={{ display: 'flex', borderBottom: '1px solid var(--border-color)', background: 'var(--bg-secondary)' }}>
              {['Tamil', 'English', 'SEO', 'Settings'].map((tab, idx) => (
                <button
                  key={tab}
                ...
                >
                  {tab}
                  {tab === 'SEO' && form.seoScore && (
                    <span style={{ marginLeft: '8px', padding: '2px 6px', borderRadius: '10px', fontSize: '11px', background: form.seoScore > 70 ? '#10B981' : '#F59E0B', color: '#fff' }}>
                      {form.seoScore}
                    </span>
                  )}
                </button>
